...
class FlashSaleProductImageWithLabel extends StatelessWidget {
  final FlashSaleProduct flashSaleProduct;

  const FlashSaleProductImageWithLabel({
    Key? key,
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(73.5, 0.1, 0, 0),
            child: Container(
              height: 23,
              width: 45,
              decoration: BoxDecoration(
